    ...
    <section class="login-area  registration_area ">
        <div class="container">
            <div class="registration_area_logo">
                 <?php if(!empty($setting->logo)): ?><img src="<?php echo e(asset($setting->logo)); ?>" alt="Login Panel" style="width:80px"><?php endif; ?>
            </div>
                            ...
                            <div class="mt-40">
                             ...
                             <div class="row">
                                ...
                                <div class="col-lg-6 d-flex relation-button">
                                    <p class="text-uppercase mb-0"><?php echo app('translator')->get('lang.guardian_relation'); ?></p>
...
<?php /**PATH C:\wamp\www\Schoolmanag\resources\views/modules/parentregistration/registration.blade.php ENDPATH**/ ?>