    ...
    <div class="container-fluid p-0">
        <div class="row mt-40">
            ...
            <div class="col-lg-8 pull-right">
                <a href="<?php echo e(url('merit-list/print', [$InputExamId, $InputClassId, $InputSectionId])); ?>" class="primary-btn small fix-gr-bg pull-right" target="_blank"><i class="ti-printer"> </i> <?php echo app('translator')->get('lang.print'); ?></a>
                                    ...
                                    <div class="card-header">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="col-lg-6 ml-30">
                                                ...
                                                <p class="text-white mb-0"><?php echo app('translator')->get('lang.email'); ?>:  <?php echo e(isset($email)?$email:'admin@demo.com'); ?> ,   <?php echo app('translator')->get('lang.phone'); ?>:  <?php echo e(isset($phone)?$phone:'admin@demo.com'); ?> </p> 
                                            </div>
                                            <div class="offset-2">
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp\www\Schoolmanag\resources\views/backEnd/reports/merit_list_report.blade.php ENDPATH**/ ?>