    ...
    <div class="container-fluid p-0">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <?php endif; ?>
                <div class="white-box">
                    <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'previous-record', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' => 'search_student'])); ?>
                            ...
                            <input type="hidden" name="url" id="url" value="<?php echo e(URL::to('/')); ?>">
                              ...
                              <div class="col-lg-4 col-md-4 sm_mb_20 sm2_mb_20">
                                    <select class="niceSelect w-100 bb promote_session form-control<?php echo e($errors->has('promote_session') ? ' is-invalid' : ''); ?>" name="promote_session" id="promote_session">
                                        ...
                                        <?php $__currentLoopData = $academic_years; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $session): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($session->id); ?>" <?php echo e(isset($year)? ($session->id == $year? 'selected':''):''); ?>><?php echo e($session->year); ?></option>
                        ...
                        <table id="table_id_tt" class="display school-table" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <?php echo e(App\SmGeneralSettings::DateConvater($data->student->date_of_birth)); ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp\www\Schoolmanag\resources\views/backEnd/examination/previous_record.blade.php ENDPATH**/ ?>