                                        ...
                                        <div class="row mt-30">
                                            <div class="col-lg-12" id="">
                                                <div class="no-gutters input-right-icon">
                                                    <div class="col">
                                                        <div class="input-effect">
                                                            <input class="read-only-input primary-input date form-control<?php echo e($errors->has('date') ? ' is-invalid' : ''); ?>" id="startDate" type="text" autocomplete="off" readonly="true" name="date" value="<?php echo e(date('d/m/Y')); ?>">
...
for($i = 1; $i <= date('d'); $i++){
    ...
    @$chart_data .= "{ day : '" . $i . "', Revenu: " . @$income . ", Dépense:" . @$expense . " },";
}
...
for($i = 1; $i <= date('m'); $i++){
    ...
    @$chart_data_yearly .= "{ y: '" . $i . "', Revenu: " . @$yearlyIncome . ", Dépense:" . @$yearlyExpense . " },";
}
...
<script type="text/javascript">
    ...
    function barChart(idName) {
        window.barChart = Morris.Bar({
            ...
            xkey: 'day',
            ykeys: ['Revenu', 'Dépense'],
            labels: ['Revenu', 'Dépense'],
            barColors: ['#0000FF', '#7FFF00'],
            resize: true,
            redraw: true,
            gridTextColor: '#4169E1		',
            gridTextSize: 12,
    ...
    "Juilletl", "Aout", "Septembre", "Octobre", "Novembre", "Decembre"
    ];
    ...
    function areaChart() {
        window.areaChart = Morris.Area({
            ...
            labels: ['Revenu', 'Dépense'],
            hideHover: 'auto',
            lineColors: ['rgba(0, 0, 255, 0.5)', 'rgba(127, 255, 0, 0.5)'],
        });
    }
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp\www\Schoolmanag\resources\views/backEnd/dashboard.blade.php ENDPATH**/ ?>