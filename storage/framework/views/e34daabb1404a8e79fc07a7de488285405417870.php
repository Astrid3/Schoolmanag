    ...
    <div class="container-fluid">
        <div class="row justify-content-between">
            ...
            <div class="bc-pages">
                ...
                <a href="<?php echo e(url('results-archive')); ?>"><?php echo app('translator')->get('lang.result'); ?>  <?php echo app('translator')->get('lang.archive'); ?>  </a> 
            </div>
        </div>
    </div>
</section>
<section class="admin-visitor-area">
    <div class="container-fluid p-0">
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="main-title">
                    <h3 class="mb-30"><?php echo app('translator')->get('lang.select'); ?> <?php echo app('translator')->get('criteria'); ?> </h3>
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            ...
            <a target="_blank" href="<?php echo e(url('previous-class-results/print',$admission_number  )); ?>" class="primary-btn small fix-gr-bg "><span class="ti-printer pr-2"></span> <?php echo app('translator')->get('lang.print'); ?>  </a>  
            </div> 
        </div>
            <div class="row mt-20">
                <div class="col-lg-12">
                                        ...
                                        <div class="card-body">
                                            <div class="white-box p-5"> 
                                                ...
                                                <div class="row mt-20 transcript-heading">
                                                    <div class="col-lg-4">
                                                        <strong><?php echo app('translator')->get('lang.student_name'); ?>:</strong> <?php echo e($studentDetails->full_name); ?> <br>
                                                        ...
                                                        ?>
                                                        <strong><?php echo app('translator')->get('lang.mother_name'); ?>:</strong> <?php echo e($mother->mothers_name); ?><br>
                                                        <strong><?php echo app('translator')->get('lang.school_name'); ?>:</strong> <?php echo e(App\SmGeneralSettings::find(1)->school_name); ?><br>
                                                    </div>
                                                    <div class="col-lg-4">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <strong><?php echo app('translator')->get('lang.date_of_birth'); ?>:</strong> <?php echo e($studentDetails->date_of_birth != ""? App\SmGeneralSettings::DateConvater($studentDetails->date_of_birth):''); ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp\www\Schoolmanag\resources\views/backEnd/reports/previousClassResults.blade.php ENDPATH**/ ?>