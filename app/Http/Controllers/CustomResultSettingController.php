...
class CustomResultSettingController extends Controller
{
    ...
    public function store(request $request)
    {
        ...
        try {
            ...
            if ($check_exist == '') {
                ...
                $custom_setting->created_at = YearCheck::getYear() . '-' . date('d-m h:i:s');
            ...
            Toastr::success('Operation avec succès', 'Succeès');
            return redirect()->back();
        } catch (\Exception $e) {
    ...
    public function edit($id)
    {
        ...
        try {
            ...
            Toastr::error('Donnée non trouvée', 'Echec');
            return redirect()->back();
        }
    }
    ...
    public function meritListReport(Request $request)
    {
        ...
        try {
            ...
            if (!empty($custom_result_setup)) {
                ...
                Toastr::warning('Please Complete Custom Setup', 'Attention');
                return redirect()->back();
            }
        } catch (Exception $e) {
    ...
    public function progressCardReportPrint(Request $request)
    {
        ...
        try {
            ...
            if ($assigned_exam->count() != 3) {
                Toastr::error('Result not found for this class', 'Echec');
                return redirect()->back();
            }
