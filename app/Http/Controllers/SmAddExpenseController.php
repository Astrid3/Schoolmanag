...
class SmAddExpenseController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        try {
            ...
            Toastr::error('Echec de l\'operation', 'Failed');
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if (ApiBaseMethod::checkUrl($request->fullUrl())) {
                if ($result) {
                    return ApiBaseMethod::sendResponse(null, 'Les frais ont été crées avec succès');
                } else {
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            if (ApiBaseMethod::checkUrl($request->fullUrl())) {
                if ($result) {
                    return ApiBaseMethod::sendResponse(null, 'Les frais ont été mis à jour avec accès');
                } else {
                    return ApiBaseMethod::sendError('Something went wrong, please try again.');
                }
            } else {
    ...
    public function destroy(Request $request, $id)
    {
        ...
        try {
            ...
            if (ApiBaseMethod::checkUrl($request->fullUrl())) {
                if ($result) {
                    return ApiBaseMethod::sendResponse(null, 'Les frais ont été mise à jour avec succès');
                } else {
                    return ApiBaseMethod::sendError('Something went wrong, please try again.');
                }
            } else {
