                    ...
                    <div class="in_login_content">
                        ...
                        <div class="in_login_page_iner">
                            ...
                            {{-- @if (App\SmGeneralSettings::isModule('Saas') == TRUE) --}}
                                   ...
                                   <div class="input-effect mb-40 in_single_input">
                                        <select class="mb-26 niceSelect infix_theme_style w-100 bb form-control{{ $errors->has('role_id') ? ' is-invalid' : '' }}" name="role_id" id="role_id">
                                            <option data-display="" value=""> Role*</option>
